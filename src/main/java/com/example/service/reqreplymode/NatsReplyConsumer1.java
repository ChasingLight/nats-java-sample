...
@Service
public class NatsReplyConsumer1 implements ISubscribe{
    ...
    public void consume(Message msg, Connection connection) {
        ...
        // 处理并响应
        System.out.println("Consumer1 Received message: " + cityName);
        String weatherInfo = weatherUtil.getWeatherInfoByCityName(cityName);
        System.out.println("Consumer1 resp info: " + weatherInfo);
